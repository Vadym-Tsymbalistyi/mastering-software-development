...
from Design_Patterns.Observer.observer import StrategyObserver , PizzaReadyObserver
...
pizza_ready_observer = PizzaReadyObserver()
director.attach(observer)
director.attach(pizza_ready_observer)
